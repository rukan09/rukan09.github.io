...
$sql_00 = "SELECT * FROM categories  WHERE catid = '$catid'";
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div class="row">
            <div class="col-md-12"> 
              <h3>Products of <?php echo $row_select['category_name']; ?></h3>
            </div>
          </div>
          ...
          <div class="row">
            ...
            $sql = "SELECT p.*, c.category_name FROM products AS p INNER JOIN categories AS c  ON p.product_category=c.catid WHERE p.product_status = '1' AND p.product_category ='$catid' ORDER BY p.product_category DESC";
